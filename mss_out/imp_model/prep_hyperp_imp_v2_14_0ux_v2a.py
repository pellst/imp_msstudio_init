...
def model_pipeline(project):
    ...
    while i < length: 
        ...
        logging.info(project["xl_groupA"][i]["crosslink_distance"])
         ...
         # as of imp 2.13 the IMP.pmi.restraints.crosslinking import CrossLinkingMassSpectrometryRestraint param pass CrossLinkDataBase object to database= param
...
parser.add_option("--testmode", action="store_true", dest="testmode", help="setup 20 frames test run")
parser.add_option("--skipmcrun", action="store_true", dest="skipmcrun", help="skip MC run")
