...
#sudo /shared/anaconda/bin/mpiexec -n 8 /shared/anaconda/bin/python prep_hyperp_imp_v2_14_0ux.py --count=1 --name=DemoImpModel --config=ConfigImp.yaml --testing --skipmcrun >/shared/imp/imp_msstudio_init-master/mss_out/imp_model$runnum/trace.log 2>&1
