...
# later version has issue running on cedar and graham - index out of range
#curl -O https://repo.anaconda.com/archive/Anaconda3-2019.07-Linux-x86_64.sh
#bash Anaconda3-2019.07-Linux-x86_64.sh -b -p /home/$USER/scratch/anaconda 
#rm -rf /home/$USER/scratch/Anaconda3-2019.07-Linux-x86_64.sh
